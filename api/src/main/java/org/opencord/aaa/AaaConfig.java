...
public class AaaConfig extends Config<ApplicationId> {
    ...
    private static final String SOCKET_BIND_PORT = "bindPort";
    ...
    // AAA socket communicator socket bind port
    protected static final String DEFAULT_SOCKET_BIND_PORT = "1812";
    ...
    /**
     * Returns the AAA app socket-based communicator socket bind UDP port.
     *
     * @return socket bind UDP port.
     */
    public short bindUdpPort() {
        return Short.parseShort(getStringProperty(SOCKET_BIND_PORT, DEFAULT_SOCKET_BIND_PORT));
    }
